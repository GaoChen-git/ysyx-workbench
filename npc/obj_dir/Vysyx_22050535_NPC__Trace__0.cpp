...
void Vysyx_22050535_NPC___024root__trace_chg_sub_0(Vysyx_22050535_NPC___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+24,((0xfU & (vlSelf->mem_inst 
                                     >> 0xfU))),4);
    bufp->chgCData(oldp+25,((0xfU & (vlSelf->mem_inst 
                                     >> 0x14U))),4);
    bufp->chgCData(oldp+26,((0xfU & (vlSelf->mem_inst 
                                     >> 7U))),4);
    ...
    bufp->chgIData(oldp+31,((0xfU & (vlSelf->mem_inst 
                                     >> 7U))),32);
    bufp->chgIData(oldp+32,((0xfU & (vlSelf->mem_inst 
                                     >> 0xfU))),32);
    bufp->chgIData(oldp+33,((0xfU & (vlSelf->mem_inst 
                                     >> 0x14U))),32);
}
