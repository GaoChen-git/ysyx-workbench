...
VL_ATTR_COLD void Vysyx_22050535_NPC___024root__trace_full_sub_0(Vysyx_22050535_NPC___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+25,((0x1fU & (vlSelf->mem_inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+26,((0x1fU & (vlSelf->mem_inst 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+27,((0x1fU & (vlSelf->mem_inst 
                                       >> 7U))),5);
    ...
    bufp->fullIData(oldp+32,((0x1fU & (vlSelf->mem_inst 
                                       >> 7U))),32);
    bufp->fullIData(oldp+33,((0x1fU & (vlSelf->mem_inst 
                                       >> 0xfU))),32);
    bufp->fullIData(oldp+34,((0x1fU & (vlSelf->mem_inst 
                                       >> 0x14U))),32);
